...
const userFieldQueryValidating = z
  .object({
    page: z.string(),
    perPage: z.string(),
  ...
  .superRefine((obj, ctx) => {
    if (obj.city && obj.province == undefined) {
      ...
      (obj.district && obj.city == undefined) ||
      ...
      (obj.sub_district && obj.district == undefined) ||
      obj.city == undefined ||
      obj.province == undefined
    ) {
      ctx.addIssue({
...
export class QueryUserListZodDTO extends createZodDto(
  userFieldQueryValidating,
) {}
